...
This document walks you through everything you need to do before Session 1. By the time you finish, you will have five tools set up and your own copy of the workshop code ready to go.
...
**1. VS Code** is the code editor. It is where you will read and write Python files. It also has a built-in terminal panel where you run all your commands without switching windows.

**2. Git Bash** is a command-line terminal for Windows that is included automatically when you install Git. You will use it as the built-in terminal inside VS Code. Every command you run in this workshop, such as activating the conda environment, running Python scripts, committing your work, happens here.

**3. Miniconda (conda)** is an environment manager. It installs Python and creates an isolated environment (a named set of packages at specific versions) so that this project's dependencies do not interfere with anything else on your computer. Every participant runs the exact same version of every package.

**4. Git** is version control. It records every change you make to your code so you can see what changed, when, and why, and undo it if something breaks.

**5. GitHub** is a cloud platform for storing and sharing Git repositories. It is where the workshop code lives and where you will back up your work. You need a free account; no software installation required.
...
| Pre-workshop questions and troubleshooting | [Teams channel link](https://teams.microsoft.com/l/chat/19:4d970a6b3f7e4a53befaa7528a3b4e70@thread.v2/conversations?context=%7B%22contextType%22%3A%22chat%22%7D) |
