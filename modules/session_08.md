...
Merge two outreach data files on `student_id` and identify which contacts are missing school information.
...
4. Print how many contacts have no school match (i.e., `school_name` is `NaN`)
