...
Open [`session_04_exercise.py`](session_04_exercise.py) and fill in the blanks marked with `# TODO:`. Every blank is either a string value (`"___"`) or a variable name (`___`). If you get stuck, the completed version is at [`session_04_answer.py`](session_04_answer.py).
