# Session 4 Exercise — Merging Three Sources
...
Open [`session_04_exercise.py`](session_04_exercise.py) and fill in the blanks marked with `# TODO:`. If you get stuck, the completed version is at [`session_04_answer.py`](session_04_answer.py).
