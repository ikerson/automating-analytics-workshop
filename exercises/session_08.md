...
2. Load `exercises/data/size_summary.csv` (produced in the Session 6 exercise)
...
Open [`session_08_exercise.py`](session_08_exercise.py) and fill in the blanks marked with `# TODO:`. Note: this exercise predefines `___ = None` at the top — a missed blank will raise a clear error rather than a silent one. If you get stuck, the completed version is at [`session_08_answer.py`](session_08_answer.py).
